			...
			<div class="panel panel-primary" data-collapsed="0">
				...
				<div class="panel-body">
					<form role="form" class="form-horizontal" @submit.prevent="newUser($event.target)">
						...
						<select-form text="Laboratorio" name="laboratorio" :options="laboratories" :data.sync="user.laboratory" v-if="user.roles.indexOf('laboratorio')!=-1"></select-form>
						<select-form text="Punto de venta" name="PDV" :options="branches" :data.sync="user.branch" v-if="user.roles.indexOf('punto de ventas')!=-1 || user.roles.indexOf('Ejecutivo')!=-1"></select-form>
